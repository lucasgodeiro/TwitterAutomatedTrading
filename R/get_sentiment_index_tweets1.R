...
#'
#'
#' This function computes the sentiment index from tweets. Remind to connect with twitter using your API Key.
#'
...
#'
#' @return A list with: (1) - the sentiment index, (2) a tibble with the words counting, (3) a tibble with the negative words counting and (4) the positive and negative words in a xts objetc.
#' @export
